#+TITLE: CLI Carousel
#+DESCRIPTION: Slot machine style CLI command carousel

* CLI Carousel Component

Section 3 of the landing page - showcases CLI tools with a scroll-driven
slot machine carousel effect.
...
.cli-carousel {
  ...
  padding-top: 104px; /* Center first item */
}
...
.cli-item.active .cli-cmd {
  color: #a6e3a1;
}

.cli-item.active .cli-desc {
  color: #cdd6f4;
}
