#+TITLE: Sphere Grid Background
#+DESCRIPTION: Three.js instanced sphere grid background

* Sphere Grid Background

Core Three.js setup for the landing page background with instanced spheres.
