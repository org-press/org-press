#+TITLE: Mobile 2D Canvas Background
#+DESCRIPTION: 2D canvas animation for mobile landing page

* Mobile Canvas Background

LED display style animation - fixed grid, animate brightness and scale only.
