...
#+DESCRIPTION: Main orchestration and scroll handling

* Landing Page Controller

Orchestrates all landing page components including the 3D background
and scroll-based formation switching.
