...
| =:use preview=         | Show execution results (default)        |
| =:use preview | withSourceCode= | Show code and results          |
...
- Use =:use preview | withSourceCode= for interactive examples
...
#+begin_export html
<pre><code>#+TITLE: Example Document
#+DATE: 2025-12-09
#+LAYOUT: default
...
- [[file:index.org][Comprehensive Rendering Examples]]
- [[file:../block-plugins.org][Block Plugins Reference]]
- [[file:../configuration.org][Configuration Guide]]
