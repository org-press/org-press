...
#+begin_export html
<pre class="src-block"><code class="language-diff">import type { OrgPressUserConfig } from "org-press/config-types";
...
#+begin_export html
<pre class="example"><code class="language-org">&#35;+begin_src tsx :use react
