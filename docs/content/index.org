...
const CHAT_SCRIPT = [
  { type: 'error', content: "Error: Cannot find module './utils'", delay: 0 },
  { type: 'ai', content: "I found the issue. The utils.ts file is missing. Want me to create it with the required exports?", delay: 800 },
  { type: 'user', content: "Yes, fix it", delay: 1600 },
  { type: 'success', content: "Done! Created utils.ts with the missing formatDate and parseConfig exports.", delay: 2200 },
];
