...
}`,X="2026-02-05",p=document.createElement("div");p.style.cssText="padding: 1rem; background: #e0f2f1; border-radius: 8px; margin: 1rem 0;";const b=JSON.parse(Q);p.innerHTML=`
