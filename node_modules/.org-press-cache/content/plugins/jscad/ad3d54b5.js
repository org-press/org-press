...
export * from 'virtual:org-press:block:jscad-model:content/plugins/jscad.org:5';
...
export default function render(containerId) {
  ...
  container.style.cssText = 'position: relative; height: 500px;';
  container.setAttribute('data-storage-key', 'block-content-plugins-jscad-org-5');

  // Import the model code from virtual module and render
  import('virtual:org-press:block:jscad-model:content/plugins/jscad.org:5').then((module) => {
