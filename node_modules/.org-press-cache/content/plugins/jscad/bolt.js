...
export * from 'virtual:org-press:block:jscad-model:content/plugins/jscad.org:8';
...
export default function render(containerId) {
  ...
  container.setAttribute('data-storage-key', 'block-content-plugins-jscad-org-8');

  // Import the model code from virtual module and render
  import('virtual:org-press:block:jscad-model:content/plugins/jscad.org:8').then((module) => {
