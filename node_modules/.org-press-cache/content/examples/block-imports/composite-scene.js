...
export * from 'virtual:org-press:block:jscad-model:content/examples/block-imports.org:9';
...
export default function render(containerId) {
  ...
  container.setAttribute('data-storage-key', 'block-content-examples-block-imports-org-9');

  // Import the model code from virtual module and render
  import('virtual:org-press:block:jscad-model:content/examples/block-imports.org:9').then((module) => {
