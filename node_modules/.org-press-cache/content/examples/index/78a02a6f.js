...
export * from 'virtual:org-press:block:jscad-model:content/examples/index.org:15';
...
export default function render(containerId) {
  ...
  container.setAttribute('data-storage-key', 'block-content-examples-index-org-15');

  // Import the model code from virtual module and render
  import('virtual:org-press:block:jscad-model:content/examples/index.org:15').then((module) => {
