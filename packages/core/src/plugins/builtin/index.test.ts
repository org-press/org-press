...
describe("builtin plugins", () => {
  describe("exports", () => {
    ...
    it("should export all plugins array (excluding CLI plugins)", () => {
      expect(allBuiltinPlugins).toBeInstanceOf(Array);
      // 15 plugins (excluding CLI plugins which are loaded lazily)
      expect(allBuiltinPlugins.length).toBe(15);
    });
  ...
  describe("plugin ordering", () => {
    it("should have mode and language plugins in builtinPlugins", () => {
      ...
      expect(builtinPlugins).toContain(domPlugin);
    ...
    it("should include all non-CLI plugins in allBuiltinPlugins", () => {
      // Mode plugins
      expect(allBuiltinPlugins).toContain(domPlugin);
  ...
  describe("plugin transformations", () => {
    ...
    it("should transform JavaScript code with :use dom", async () => {
      const block = {
        value: 'console.log("hello");',
        language: "javascript",
        meta: ":use dom",
