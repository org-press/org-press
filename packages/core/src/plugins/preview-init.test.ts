/**
 * Tests for Render API initialization
 */
...
describe("Render API Initialization", () => {
  beforeEach(() => {
    resetRenderApiInit();
  });
  ...
  it("should not be initialized initially", () => {
    ...
    expect(typeof isRenderApiInitialized()).toBe("boolean");
  });

  it("should initialize on first call", () => {
    initializeRenderApi();
    expect(isRenderApiInitialized()).toBe(true);
  });
  ...
  it("should reset initialization state", () => {
    ...
    resetRenderApiInit();
    expect(isRenderApiInitialized()).toBe(false);
  });
});
