...
describe("HydrateRegistry", () => {
  ...
  describe("generateHydrateEntry", () => {
    it("should generate correct code for a single block", () => {
      ...
      // Check hydrate function exists
      expect(code).toContain("function hydrate()");
    ...
    it("should handle both direct function and default exports", () => {
      ...
      // Check both export types are handled
      expect(code).toContain('if (typeof mod === "function")');
      expect(code).toContain('mod(el.id)');
      expect(code).toContain('typeof mod.default === "function"');
      expect(code).toContain('mod.default(el.id)');
    });
