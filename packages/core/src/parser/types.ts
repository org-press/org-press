 ...
 * - `:use preview` - Execute and render with Preview function (default)
 ...
 * - `:use preview | withSourceCode` - Show both source and result
 * - `:use preview | withCollapse?open` - Collapsible output
