 ...
 * - ORGP_BASE or BASE_PATH - Override base
...
export function getEnvOverrides(): Partial<OrgPressConfig> {
  ...
  // Support both ORGP_BASE and BASE_PATH (common convention)
  if (process.env.ORGP_BASE || process.env.BASE_PATH) {
    overrides.base = process.env.ORGP_BASE || process.env.BASE_PATH;
  }
