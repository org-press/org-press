...
| `@org-press/fmt` | Format code blocks with Prettier |
| `@org-press/lint` | Lint code blocks with ESLint |
| `@org-press/type-check` | Type-check TypeScript blocks |
...
```bash
npm install @org-press/fmt @org-press/lint @org-press/type-check
```
...
Org-press is built on the shoulders of giants:

- **[Vite](https://vitejs.dev/)** - The lightning-fast build tool that powers our dev server and production builds
- **[Uniorg](https://github.com/rasendubi/uniorg)** - The excellent org-mode parser for JavaScript that makes this project possible
- **[Unified](https://unifiedjs.com/)** - The powerful content processing ecosystem (rehype, remark, and friends)
- **[Highlight.js](https://highlightjs.org/)** - Syntax highlighting for code blocks
- **[React](https://react.dev/)** - UI components and the JSX transform
